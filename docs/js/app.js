(() => {
    ...
    function initSliders() {
        if (document.querySelector(".sec-01__slider")) var swiper = new Swiper(".sec-01__slider", {
            ...
            on: {
                ...
                slideChange: function() {
                    ...
                    var sectionBody = this.el.closest(".sec-01__body");
                    for (var i = 1; i <= swiper.slides.length; i++) sectionBody.classList.remove("slide-" + i);
                    ...
                    bullets.forEach(((bullet, index) => {
                        ...
                        bullet.classList.remove("swiper-pagination-bullet-active-prev-prev", "swiper-pagination-bullet-active-prev", "swiper-pagination-bullet-active", "swiper-pagination-bullet-active-next", "swiper-pagination-bullet-active-next-next");
                        if (index === activeIndex2) bullet.classList.add("swiper-pagination-bullet-active"); else if (index === activeIndex2 - 1) bullet.classList.add("swiper-pagination-bullet-active-prev"); else if (index === activeIndex2 - 2) bullet.classList.add("swiper-pagination-bullet-active-prev-prev"); else if (index === activeIndex2 + 1) bullet.classList.add("swiper-pagination-bullet-active-next"); else if (index === activeIndex2 + 2) bullet.classList.add("swiper-pagination-bullet-active-next-next");
                    }));
                }
            }
        });
